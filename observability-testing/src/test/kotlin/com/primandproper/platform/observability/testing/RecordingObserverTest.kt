...
class RecordingObserverTest {
    ...
    @Test
    fun setLandsOnBothPillarsWhileSpanOnlyAndLogOnlyDoNot() = runTest {
    ...
    @Test
    fun spanScopeRecordsAndRethrowsThrownException() = runTest {
        val observer = RecordingObserver()
    ...
    @Test
    fun streamOrdersObservationsAcrossOperations() = runTest {
        val observer = RecordingObserver()
